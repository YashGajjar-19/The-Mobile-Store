<footer class="footer">
    ...
    <div class="footer-content">
        ...
        <div class="footer-section">
            ...
            <p>
                Your one-stop shop for the latest mobile devices. We bring the future to your
                fingertips.
            </p>
        ...
        <div class="footer-section">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo $base_path; ?>pages/about-us.php">
                        About Us
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo $base_path; ?>pages/privacy-policy.php">
                        Privacy Policy
                    </a>
                </li>
            </ul>
        ...
        <div class="footer-section">
            ...
            <ul>
                <li>
                    <a href="<?php echo $base_path; ?>pages/faq.php">
                        FAQ
                    </a>
                </li>

                <li>
                    <a href="<?php echo $base_path; ?>pages/returns.php">
                        Returns & Refunds
                    </a>
                </li>

                <li>
                    <a href="<?php echo $base_path; ?>pages/shipping.php">
    ...
    <div class="footer-bottom">
        &copy; <?php echo date("Y"); ?> The Mobile Store. All rights reserved.
    </div>
</footer>
